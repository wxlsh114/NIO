...
def fun_getinfo(self):
    ...
    mobile_no0=int(st1.cell(1,0).value)
...
#*******************************************************************************************************
#Name:fun_is_toast_exist
#Purpose:判断包含相关文本的toast是否存在
#Parameters:入口参数无
#Outputs:返回True/False值
#Example:N/A
#Modified history:2018/08/29
#*******************************************************************************************************
def fun_is_toast_exist(driver,text,timeout=10,poll_frequency=0.2):
    print('Common_检查用户模式登录APP，检查点:包含相关文本的toast是否存在')
    try:
