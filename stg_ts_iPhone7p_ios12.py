...
class Weilai_test(unittest.TestCase):
    ...
    if __name__ == '__main__':
        ...
        testunit.addTest(stg_tc_iPhone7p_ios12.Weilai_test('test_aiche_milecalculator_tc051'))
        ...
        ###testunit.addTest(stg_tc_iPhone7p_ios12.Weilai_test('test_faxian_tryes6noncarowner_tc105'))
        ...
        runner=HTMLTestRunner(stream=fp,title='iPhone7Plus_iOS12.1.4真机\
                              v3.4.0_build:2949_发现/朋友/惊喜/爱车/我的UI测试报告by Appium',\
