...
#version:iOS11.4.1
#author: Sam Wang
#update date: created by Sam [2018-11-29]
...
from common_iPhone6_ios11_stg import fun_myfansui_check
from common_iPhone6_ios11_stg import fun_mywatchui_check
from common_iPhone6_ios11_stg import fun_mypublishui_check
from common_iPhone6_ios11_stg import bp_is_loggedin
from common_iPhone6_ios11_stg import fun_getinfo
from common_iPhone6_ios11_stg import bp_normalloginmp
from common_iPhone6_ios11_stg import bp_is_loginshow
from common_iPhone6_ios11_stg import fun_getloginmenu
from common_iPhone6_ios11_stg import bp_is_plusexist
from common_iPhone6_ios11_stg import bp_is_publishnowexist
from common_iPhone6_ios11_stg import bp_is_openmultichatexist
from common_iPhone6_ios11_stg import fun_findui_check
from common_iPhone6_ios11_stg import fun_personalinfoui_check
from common_iPhone6_ios11_stg import fun_scoredetailui_check
from common_iPhone6_ios11_stg import fun_giftui_check
from common_iPhone6_ios11_stg import fun_articleui_check
from common_iPhone6_ios11_stg import fun_cartui_check
from common_iPhone6_ios11_stg import fun_pgcui_check
#from common_iPhone6_ios11_stg import fun_articledetailui_check
#from common_iPhone6_ios11_stg import fun_giftorderui_check
#from common_iPhone6_ios11_stg import fun_giftorderdetailui_check
from common_iPhone6_ios11_stg import fun_getjingxiloginmenu
from common_iPhone6_ios11_stg import bp_deleteaddress
...
#*******************************************************
    def test_wode_publish_tc003(self):
        ...
        if c1==True:
            ...
            sleep(1)
            title0=title0.get_attribute('value')
            #print(title0)
            #sleep(1)
            if t in title0:
                print('发布降序排列验证检查通过')
...
#*******************************************************
    def test_faxian_article_tc019(self):
        ...
        if c1 == True:
            ...
            sleep(2)
            #点击评论
            driver.find_element_by_xpath('//XCUIElementTypeScrollView/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[8]/XCUIElementTypeButton[3]').click()
            sleep(3)
...
#*******************************************************************
    def test_pengyou_dismissmultichat_tc021(self):
        ...
        if len(mul) != 0:
            ...
            driver.execute_script("mobile: tap", {"touchCount":"1", "x":322, "y":160})
            sleep(2)
...
#*********************************************************************************************
    def test_jingxi_add2basket_tc022(self):
        ...
        driver.execute_script("mobile: dragFromToForDuration",{"fromX":50,"fromY":300,"toX":50,"toY":450,"duration":1.0})
        sleep(2)
        u1=driver.find_elements_by_xpath('//XCUIElementTypeOther[@name="真皮iPhone手机壳 真皮iPhone手机壳 200 车主价 250"]')
        if len(u1) != 0:
            print('需要兑换的商品存在，检查通过')
            sleep(2)
            driver.find_element_by_xpath('//XCUIElementTypeOther[@name="真皮iPhone手机壳 真皮iPhone手机壳 200 车主价 250"]').click()
            sleep(9)
            ...
            if chk == True:
                ...
                try:
                    ...
                    if len(chk) == 0:
                        ...
                        sleep(6)
                        #检查商品状态
                        chk1=driver.find_elements_by_xpath('//XCUIElementTypeOther[contains(@name,"真皮iPhone手机壳")]')
...
#*******************************************************
    def test_faxian_ugcshare_tc034(self):
        ...
        if len(u) != 0:
            ...
            #driver.execute_script('mobile: dragFromToForDuration',{'fromX':50,'fromY':500,'toX':50,'toY':200,'duration':1.0})
            #sleep(2)
            driver.find_elements_by_xpath('//XCUIElementTypeStaticText[contains(@name,"SamSTG")]')[0].click()
            sleep(2)
            #...more icon 原来
            driver.find_element_by_xpath('//XCUIElementTypeButton[@name="icon share gray background new"]').click()
            sleep(2)
...
#*******************************************************
    def test_faxian_experjoin_tc038(self):
        ...
        sleep(2)
        for i in range(3):
            driver.execute_script('mobile: dragFromToForDuration',{'fromX':50,'fromY':500,'toX':50,'toY':70,'duration':1.0})
            sleep(1)
        sleep(2)
        #自动化测试活动1
        ...
        if len(joins) != 0:
            ...
            #sleep(1)
            driver.execute_script('mobile: dragFromToForDuration',{'fromX':350,'fromY':550,'toX':350,'toY':50,'duration':1.0})
            sleep(2)
            #姓名
            name=driver.find_elements_by_class_name('XCUIElementTypeTextField')[0]
            name.click()
...
#*******************************************************
    def test_jingxi_giftshare_tc041(self):
        ...
        driver.execute_script("mobile: dragFromToForDuration",{"fromX":50,"fromY":300,"toX":50,"toY":450,"duration":1.0})
        sleep(2)
        u=driver.find_elements_by_xpath('//XCUIElementTypeOther[@name="真皮iPhone手机壳 真皮iPhone手机壳 200 车主价 250"]')
        if len(u) != 0:
            print('需要兑换的商品存在，检查通过')
            sleep(2)
            driver.find_element_by_xpath('//XCUIElementTypeOther[@name="真皮iPhone手机壳 真皮iPhone手机壳 200 车主价 250"]').click()
...
#*******************************************************
    def test_jingxi_visitor_tc042(self):
        ...
        for i in range(4):
            driver.execute_script("mobile: scroll", {"direction": "down"})
            sleep(1)
        driver.execute_script("mobile: dragFromToForDuration",{"fromX":50,"fromY":300,"toX":50,"toY":400,"duration":1.0})
        sleep(2)
        u=driver.find_elements_by_xpath('//XCUIElementTypeOther[@name="真皮iPhone手机壳 真皮iPhone手机壳 200 车主价 250"]')
        if len(u) != 0:
            print('需要兑换的商品存在，检查通过')
        ...
        if len(u1) != 0:
            ...
            if len(add2b) != 0:
                ...
                if len(ch1) != 0:
                    ...
                    driver.execute_script('mobile: tap', {'touchCount':'1', 'x':34, 'y':58})
                    sleep(2)
                    u2=driver.find_elements_by_xpath('//XCUIElementTypeOther[@name="纽北圈速记录Tee 纽北圈速记录Tee 2 车主价 6"]')
                    if len(u2) != 0:
                        print('需要兑换的商品2存在，检查通过')
                        sleep(2)
                        driver.find_element_by_xpath('//XCUIElementTypeOther[@name="纽北圈速记录Tee 纽北圈速记录Tee 2 车主价 6"]').click()
                        sleep(8)
                        #page=driver.page_source
                        #sleep(2)
...
#*******************************************************
    def test_aiche_milecalculator_tc051(self):
        ...
        for i in range(4):
            ...
            sleep(1)
        for i in range(2):
            driver.execute_script('mobile: dragFromToForDuration',{'fromX':50,'fromY':420,'toX':80,'toY':100,'duration':1.0})
            sleep(1)
        driver.execute_script("mobile: scroll", {"direction": "down"})
        sleep(2)
...
#*********************************************************************************************
#TC Name:test_wode_publishorder_tc000
#Purpose:检查车主从爱车页面进入点亮中国首页的校验功能测试
#OS:iOS
#Device:iPhone6
#Pre-conditions:车主用户已正常登录app
...
#Modify History:created by Sam [2018/12/04]
#*********************************************************************************************
    def test_wode_publishorder_tc000(self):
        driver=self.driver
        now=time.strftime('%Y%m%d_%H%M%S')
        print('TC_我的_我的_发布页面元素取值验证----开始:'+now)
        sleep(2)
        driver.find_element_by_accessibility_id('返回').click()
        sleep(2)
        #我的
        ...
        #page=driver.page_source
        #sleep(2)
        title=driver.find_element_by_xpath('//XCUIElementTypeTable/XCUIElementTypeCell[1]/XCUIElementTypeTextView')
        sleep(1)
        title_i=title.get_attribute('value')
        print(title_i)
        sleep(1)
        if t in title_i:
            print('发布降序排列验证检查通过')
            ...
            sleep(1)
            now=time.strftime('%Y%m%d_%H%M%S')
            sf3='../../test_report/ios/'+now+'_errorPublishOrder_R_stg_tc000.png'
            driver.get_screenshot_as_file(sf3)
        sleep(1)
        driver.find_element_by_accessibility_id('all page back black icon').click()
        sleep(1)
        now=time.strftime('%Y%m%d_%H%M%S')
        print('TC_我的_发布页面元素取值验证----结束:'+now)
