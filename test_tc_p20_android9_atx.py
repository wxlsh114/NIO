...
from common_p20_android9_atx import fun_myfansui_check
from common_p20_android9_atx import fun_mywatchui_check
from common_p20_android9_atx import fun_mypublishui_check
from common_p20_android9_atx import bp_is_loggedin
from common_p20_android9_atx import fun_getinfo
from common_p20_android9_atx import bp_normalloginmp
from common_p20_android9_atx import bp_is_loginshow
from common_p20_android9_atx import fun_getloginmenu
from common_p20_android9_atx import bp_is_plusexist
from common_p20_android9_atx import bp_is_publishnowexist
from common_p20_android9_atx import bp_is_openmultichatexist
from common_p20_android9_atx import fun_findui_check
from common_p20_android9_atx import fun_personalinfoui_check
from common_p20_android9_atx import fun_scoredetailui_check
from common_p20_android9_atx import fun_giftui_check
from common_p20_android9_atx import fun_articleui_check
from common_p20_android9_atx import fun_cartui_check
from common_p20_android9_atx import fun_pgcui_check
from common_p20_android9_atx import fun_articledetailui_check
from common_p20_android9_atx import fun_giftorderui_check
from common_p20_android9_atx import fun_giftorderdetailui_check
...
#*******************************************************
    def test_wode_checkin_tc025(self):
        ...
        #我的
        ###d(text='我的').click()
        d.xpath('//android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.RelativeLayout[5]/android.widget.RelativeLayout[1]/android.widget.LinearLayout[1]/android.widget.TextView[1]').click()
        ###d(resourceId='cn.com.weilaihui3:id/custom_tab_tv')[3].click()
        ###d.click(970,2044)
        ###d(text='我的', className='android.widget.TextView')
        sleep(4)
        #点击签到
