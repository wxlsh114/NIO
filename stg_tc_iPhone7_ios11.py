...
from common_iPhone7_ios11_stg import fun_myfansui_check
from common_iPhone7_ios11_stg import fun_mywatchui_check
from common_iPhone7_ios11_stg import fun_mypublishui_check
from common_iPhone7_ios11_stg import bp_is_loggedin
from common_iPhone7_ios11_stg import fun_getinfo
from common_iPhone7_ios11_stg import bp_normalloginmp
from common_iPhone7_ios11_stg import bp_is_loginshow
from common_iPhone7_ios11_stg import fun_getloginmenu
from common_iPhone7_ios11_stg import bp_is_plusexist
from common_iPhone7_ios11_stg import bp_is_publishnowexist
from common_iPhone7_ios11_stg import bp_is_openmultichatexist
from common_iPhone7_ios11_stg import fun_findui_check
from common_iPhone7_ios11_stg import fun_personalinfoui_check
from common_iPhone7_ios11_stg import fun_scoredetailui_check
from common_iPhone7_ios11_stg import fun_giftui_check
from common_iPhone7_ios11_stg import fun_articleui_check
from common_iPhone7_ios11_stg import fun_cartui_check
from common_iPhone7_ios11_stg import fun_pgcui_check
#from common_iPhone7_ios11_stg import fun_articledetailui_check
#from common_iPhone7_ios11_stg import fun_giftorderui_check
#from common_iPhone7_ios11_stg import fun_giftorderdetailui_check
from common_iPhone7_ios11_stg import fun_getjingxiloginmenu
...
#*******************************************************
    def test_faxian_tabcheck_tc010(self):
        ...
        sleep(2)
        for i in range(6):
            driver.execute_script('mobile: dragFromToForDuration',{'fromX':50,'fromY':500,'toX':50,'toY':51,'duration':1.0})
            sleep(2)
...
#*******************************************************
    def test_jingxi_products_tc013(self):
        ...
        sleep(8)
        for i in range(1):
            driver.execute_script('mobile: dragFromToForDuration',{'fromX':50,'fromY':500,'toX':50,'toY':350,'duration':1.0})
            sleep(2)
        #driver.execute_script('mobile: dragFromToForDuration',{'fromX':50,'fromY':550,'toX':50,'toY':350,'duration':1.0})
        sleep(2)
        #惊喜页面的各个元素是否存在
...
#*******************************************************
    def test_faxian_article_tc019(self):
        ...
        if c1 == True:
            ...
            sleep(2)
            #点击评论
            driver.find_element_by_xpath('//XCUIElementTypeScrollView/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[7]/XCUIElementTypeButton[3]').click()
            sleep(3)
...
#*********************************************************************************************
    def test_jingxi_add2basket_tc022(self):
        ...
        #driver.execute_script('mobile: dragFromToForDuration',{'fromX':50,'fromY':550,'toX':50,'toY':350,'duration':1.0})
        sleep(2)
        u1=driver.find_elements_by_xpath('//XCUIElementTypeOther[@name="真皮iPhone手机壳 真皮iPhone手机壳 1"]')
        if len(u1) != 0:
            print('需要兑换的商品存在，检查通过')
            sleep(2)
            driver.find_element_by_xpath('//XCUIElementTypeOther[@name="真皮iPhone手机壳 真皮iPhone手机壳 1"]').click()
            sleep(9)
...
#*******************************************************
    def test_jingxi_giftshare_tc041(self):
        ...
        #driver.execute_script('mobile: dragFromToForDuration',{'fromX':50,'fromY':550,'toX':50,'toY':350,'duration':1.0})
        sleep(2)
        u=driver.find_elements_by_xpath('//XCUIElementTypeOther[@name="真皮iPhone手机壳 真皮iPhone手机壳 1 车主专享"]')
        if len(u) != 0:
            print('需要兑换的商品存在，检查通过')
            sleep(2)
            driver.find_element_by_xpath('//XCUIElementTypeOther[@name="真皮iPhone手机壳 真皮iPhone手机壳 1 车主专享"]').click()
            sleep(8)
            #分享图标
...
#*******************************************************
    def test_jingxi_visitor_tc042(self):
        ...
        #driver.execute_script('mobile: dragFromToForDuration',{'fromX':50,'fromY':550,'toX':50,'toY':350,'duration':1.0})
        sleep(2)
        u=driver.find_elements_by_xpath('//XCUIElementTypeOther[@name="真皮iPhone手机壳 真皮iPhone手机壳 1"]')
        if len(u) != 0:
            print('需要兑换的商品存在，检查通过')
            sleep(2)
            driver.find_element_by_xpath('//XCUIElementTypeOther[@name="真皮iPhone手机壳 真皮iPhone手机壳 1"]').click()
        ...
        if len(u1) != 0:
            ...
            if len(add2b) != 0:
                ...
                if len(ch1) != 0:
                    ...
                    driver.execute_script('mobile: tap', {'touchCount':'1', 'x':34, 'y':58})
                    sleep(2)
                    u2=driver.find_elements_by_xpath('//XCUIElementTypeOther[@name="百利甜情人蛋糕 21 Cake · 百利甜情人蛋糕 5"]')
                    if len(u2) != 0:
                        print('需要兑换的商品2存在，检查通过')
                        sleep(2)
                        driver.find_element_by_xpath('//XCUIElementTypeOther[@name="百利甜情人蛋糕 21 Cake · 百利甜情人蛋糕 5"]').click()
                        sleep(8)
                        #page=driver.page_source
                        #sleep(2)
