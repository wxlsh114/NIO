#coding=utf-8
#test purpose: verify the main features on Smartisan
#os: Android
#device: Jianguo Pro2(OS103)
#version:android 7.1
#author: Sam Wang
...
from common_cz_android7 import fun_myfansui_check
from common_cz_android7 import fun_mywatchui_check
from common_cz_android7 import fun_mypublishui_check
from common_cz_android7 import bp_is_loggedin
from common_cz_android7 import fun_getinfo
from common_cz_android7 import bp_normalloginmp
from common_cz_android7 import bp_is_loginshow
from common_cz_android7 import fun_getloginmenu
from common_cz_android7 import bp_is_plusexist
from common_cz_android7 import bp_is_publishnowexist
from common_cz_android7 import bp_is_openmultichatexist
from common_cz_android7 import fun_findui_check
from common_cz_android7 import fun_personalinfoui_check
from common_cz_android7 import fun_scoredetailui_check
from common_cz_android7 import fun_giftui_check
from common_cz_android7 import fun_articleui_check
from common_cz_android7 import fun_cartui_check
from common_cz_android7 import fun_pgcui_check
...
class Weilai_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        desired_caps['deviceName'] = 'OS103'
        #desired_caps['udid'] = '1fc020ee'
...
#*******************************************************
    def test_pengyou_nicknameheadicon_tc028(self):
        ...
        if '群聊' in t:
            ...
            driver.find_element_by_id('cn.com.weilaihui3:id/choose_up_button').click()
            sleep(2)
            driver.find_element_by_id('com.android.camera2:id/cameraswitch_btn').click()
            sleep(3)
            #com.android.camera2:id/shutter_button
            driver.find_element_by_xpath('//android.widget.ImageView[@content-desc="拍照"]').click()
            sleep(3)
            driver.find_element_by_id('com.android.camera2:id/btn_done').click()
            sleep(15)
            #修改头像
            driver.find_element_by_id('cn.com.weilaihui3:id/group_header').click()
            sleep(2)
            ...
            #sleep(2)
            #driver.tap([(488,255)],2000)
            #not working
            driver.find_element_by_xpath('//*[@resource-id="com.android.gallery3d:id/gallery_accessibility"]/GLView[9]').click()
            sleep(2)
    ...
    def test_faxian_ugcshare_tc034(self):
        ...
        if len(u) != 0:
            ...
            if len(wh) != 0:
                ...
                sleep(1)
                word=driver.find_element_by_id('com.tencent.mm:id/alw')
                word.click()
                sleep(1)
                now0=time.strftime('%Y-%m-%d %H_%M_%S')
            ...
            if len(pyq) != 0:
                ...
                sleep(8)
                word2=driver.find_element_by_id('com.tencent.mm:id/dez')
                word2.click()
                sleep(1)
                ...
                driver.find_element_by_id('com.tencent.mm:id/hd').click()
                #sleep(1)
                #检查toast
...
#*******************************************************
    def test_jingxi_add2basket_tc022(self):
        ...
        sleep(6)
        for i in range(3):
            driver.swipe(50,1400,50,300,1000)
            sleep(2)
        sleep(2)
        u=driver.find_elements_by_xpath('//*[@text="纯积分商品se"]')
        if len(u) != 0:
            print('需要兑换的商品存在，检查通过')
            sleep(2)
            driver.find_element_by_xpath('//android.widget.TextView[@text="纯积分商品se"]').click()
            sleep(2)
            #加入购物车
            add2b=driver.find_elements_by_xpath('//android.widget.TextView[@text="加入购物车"]')
            if len(add2b) != 0:
                ...
                sleep(1)
                #蓝色
                driver.find_element_by_android_uiautomator('new UiSelector().text("蓝色")').click()
                sleep(1)
                ...
                #sleep(2)
                #点击购物车图标
                #driver.tap([(250,1740)],2000)
                #long_press here
                #driver.execute_script('mobile: tap', {'tapCount': 1, 'touchCount': 1, 'duration': 2, 'x': 250, 'y': 1740 })
                #driver.execute_script('adb shell input tap 250 1740')
                TouchAction(driver).long_press(x=250,y=1740,duration=2000).release().perform()
                sleep(3)
                #检查购物车页面ui
