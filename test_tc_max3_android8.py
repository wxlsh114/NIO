...
#version:android 8.1
#author: Sam Wang
#update date: created by Sam [2018-08-26]
...
from common_max3_android8 import fun_myfansui_check
from common_max3_android8 import fun_mywatchui_check
from common_max3_android8 import fun_mypublishui_check
from common_max3_android8 import bp_is_loggedin
from common_max3_android8 import fun_getinfo
from common_max3_android8 import bp_normalloginmp
from common_max3_android8 import bp_is_loginshow
from common_max3_android8 import fun_getloginmenu
from common_max3_android8 import bp_is_plusexist
from common_max3_android8 import bp_is_publishnowexist
from common_max3_android8 import bp_is_openmultichatexist
from common_max3_android8 import fun_findui_check
from common_max3_android8 import fun_personalinfoui_check
from common_max3_android8 import fun_scoredetailui_check
from common_max3_android8 import fun_giftui_check
from common_max3_android8 import fun_articleui_check
from common_max3_android8 import fun_cartui_check
from common_max3_android8 import fun_pgcui_check
from common_max3_android8 import fun_articledetailui_check
from common_max3_android8 import fun_giftorderui_check
from common_max3_android8 import fun_giftorderdetailui_check
from common_max3_android8 import fun_getjingxiloginmenu
...
class Weilai_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        desired_caps['deviceName'] = 'nitrogen'
        #desired_caps['udid'] = '6036a61d'
...
#*******************************************************
    def test_wode_fans_tc001(self):
        ...
        for j in range(2):
            ...
            if (len(n1) != 0 or len(m1) != 0) and (len(n2) == 0 and len(m2) == 0):
                print('取消互相关注的功能检查通过--互相关注-->+关注')
            elif (len(n2) != 0 or len(m2) != 0) and (len(n1) == 0 and len(m1) == 0):
...
#*******************************************************
    def test_wode_personalinfo_tc011(self):
        ...
        if c1 == True:
            ...
            """
            #clear昵称
            driver.find_element_by_id('cn.com.weilaihui3:id/login_update_user_message_delete_button').click()
            sleep(1)
            nick=driver.find_element_by_id('cn.com.weilaihui3:id/login_update_user_message_nickname_edit')
            if '昵称' == nick.text:
                print('清除昵称功能检查通过')
            ...
            #clear简介
            """
            driver.find_element_by_id('cn.com.weilaihui3:id/login_update_remark_delete_button').click()
            sleep(1)
            intro=driver.find_element_by_id('cn.com.weilaihui3:id/login_update_update_intro')
            if '暂无个人简介' == intro.text:
                print('清除简介功能检查通过')
            else:
...
#*******************************************************
    def test_faxian_article_tc019(self):
        ...
        #driver.find_element_by_xpath('//*[@text="发现"]').click()
        #sleep(2)
        driver.swipe(50,1700,50,500,1000)
        sleep(2)
        driver.swipe(50,1700,50,500,1000)
        sleep(2)
        #检查文章的各个元素是否存在
        ...
        if c1 == True:
            ...
            sleep(1)
            #点击评论
            cbtn=driver.find_elements_by_id('cn.com.weilaihui3:id/ugc_list_bottom_comment_text')
            if len(cbtn) != 0:
                driver.find_element_by_id('cn.com.weilaihui3:id/ugc_list_bottom_comment_text').click()
                sleep(2)
                driver.swipe(50,1200,50,1500,1000)
                sleep(2)
    ...
    def test_faxian_openmultichat_tc020(self):
        ...
        if c1 == True:
            ...
            if c2 == True:
                ...
                sleep(1)
                driver.find_element_by_id('cn.com.weilaihui3:id/img_back').click()
                sleep(1)
                #朋友
                driver.find_element_by_xpath('//*[@text="朋友"]').click()
                sleep(2)
                #检查群聊的发送内容是否正确
                t=driver.find_element_by_xpath('//android.widget.FrameLayout[2]/android.widget.RelativeLayout[1]/android.widget.RelativeLayout[2]/android.widget.TextView[1]')
                #print(t.text)
                if '人生苦短群聊:'+now0 in t.text:
                    print('群聊的发送内容正确')
                    sleep(1)
                else:
...
#*******************************************************************
    def test_pengyou_dismissmultichat_tc021(self):
        ...
        if len(mul) != 0:
            ...
            sleep(2)
            #...
            driver.find_element_by_id('cn.com.weilaihui3:id/img_more').click()
            sleep(2)
            #-
            ...
            sleep(2)
            #检查是否已被移出群组
            n_msg=driver.find_elements_by_id('cn.com.weilaihui3:id/tv_tips')
            t1=driver.find_elements_by_id('cn.com.weilaihui3:id/tv_tips')[len(n_msg)-1]
            #'你将'+name1+'移出群组'
            if '被踢出群组' in t1.text:
                print('踢人出群聊的功能检查通过')
                sleep(1)
            ...
            sleep(3)
            #邀请
            ask=driver.find_elements_by_id('cn.com.weilaihui3:id/common_alert_dialog_right_text')
            if len(ask) != 0:
                driver.find_element_by_id('cn.com.weilaihui3:id/common_alert_dialog_right_text').click()
            sleep(2)
            driver.find_element_by_id('cn.com.weilaihui3:id/navigation_back_icon').click()
            ...
            #检查是否已被邀请加入群组
            n_msg=driver.find_elements_by_id('cn.com.weilaihui3:id/tv_tips')
            t2=driver.find_elements_by_id('cn.com.weilaihui3:id/tv_tips')[len(n_msg)-1]
            sleep(1)
            #'你邀请'+name2+'加入群组'
            if '加入了群组' in t2.text:
            ...
            sleep(2)
            #解散并退出
            driver.find_element_by_xpath('//*[@text="解散并退出"]').click()
            sleep(1)
            driver.find_element_by_xpath('//*[@text="确定"]').click()
            sleep(5)
            #检查解散的群聊是否还存在
            title1=driver.find_element_by_xpath('//android.widget.FrameLayout[2]/android.widget.RelativeLayout[1]/android.widget.RelativeLayout[2]/android.widget.TextView[1]')
...
#*******************************************************
    def test_jingxi_add2basket_tc022(self):
        ...
        driver.find_element_by_xpath('//*[@text="惊喜"]').click()
        sleep(6)
        driver.swipe(50,1300,50,600,1000)
        sleep(2)
        page=driver.page_source
        sleep(2)
        u=driver.find_elements_by_xpath('//android.widget.TextView[@text="儿童硅胶餐垫套装"]')
        if len(u) != 0:
            print('需要兑换的商品存在，检查通过')
            sleep(2)
            driver.find_element_by_xpath('//android.widget.TextView[@text="儿童硅胶餐垫套装"]').click()
            sleep(9)
            ...
            if chk == True:
                ...
                try:
                    ...
                    if len(chk) == 0:
                        ...
                        sleep(6)
                        #检查商品状态
                        chk1=driver.find_elements_by_xpath('//android.widget.TextView[@text="儿童硅胶餐垫套装"]')
...
#*******************************************************
    def test_pengyou_nicknameheadicon_tc028(self):
        ...
        if len(mul) != 0:
            ...
            sleep(1)
            edit=driver.find_element_by_id('cn.com.weilaihui3:id/et_update_group_name')
            edit.click()
            sleep(1)
            edit.clear()
            sleep(1)
            ...
            if len(allow2) != 0:
                ...
                sleep(1)
            #前后置切换
            face=driver.find_elements_by_xpath('//*[@content-desc="打开美颜面板"]')
            if len(face) == 0:
                driver.find_element_by_id('com.android.camera:id/v9_camera_picker').click()
                sleep(2)
            driver.find_element_by_id('com.android.camera:id/v9_shutter_button_internal').click()
            sleep(3)
            #driver.find_element_by_xpath('//android.widget.ImageView[@content-desc="Done"]').click()
            ...
            sleep(2)
            driver.find_element_by_xpath('//*[@text="Pictures"]').click()
            sleep(2)
            driver.find_elements_by_id('com.miui.gallery:id/pick_num_indicator')[1].click()
            sleep(15)
            driver.find_element_by_id('cn.com.weilaihui3:id/navigation_back_icon').click()
            sleep(1)
...
#*******************************************************
    def test_wode_resetsecupwd_tc030(self):
        ...
        driver.find_element_by_xpath('//*[@text="我的"]').click()
        sleep(4)
        driver.swipe(50,700,50,300,1000)
        sleep(2)
        #设置      
        driver.find_element_by_id('cn.com.weilaihui3:id/my_palace_setting_layout').click()
        sleep(2)
...
#*******************************************************
    def test_faxian_expershowpic_tc032(self):
        ...
        if len(show) != 0:
            ...
            #print(title.text)
            if '人生苦短体验晒图:'+now0 in title.text:
                print('体验晒图的文字检查通过')
            else:
    ...
    def test_faxian_publishnowatfriend_tc033(self):
        ...
        if c1 == True:
            ...
            if c2 == True:
                ...
                fb=driver.find_elements_by_xpath('//*[contains(@text,"@了你")]')
                if len(fb) != 0:
                    print('好友收到@通知检查通过')
                else:
    ...
    def test_faxian_ugcshare_tc034(self):
        ...
        if len(u) != 0:
            ...
            if len(wh) != 0:
                ...
                if len(save1) != 0 or len(save1a) != 0:
                    print('分享微信好友成功')
                else:
            ...
            if len(pyq) != 0:
                ...
                if len(save2) != 0 or len(save2a) != 0:
                    print('分享朋友圈成功')
                else:
                    print('分享朋友圈失败，请检查原因')
                    now=time.strftime('%Y-%m-%d %H_%M_%S')
            ...
            if len(mf) != 0:
                ...
                if len(save4) != 0 or len(save4a) != 0:
                    print('分享我的朋友成功')
                else:
...
#*******************************************************
    def test_faxian_experjoin_tc038(self):
        ...
        driver.find_element_by_id('cn.com.weilaihui3:id/loi_cur_store_tip').click()
        sleep(2)
        driver.swipe(50,1500,50,1200,1000)
        sleep(2)
...
#*******************************************************
    def test_jingxi_giftshare_tc041(self):
        ...
        if len(u) != 0:
            ...
            sleep(2)
            #分享图标
            share=driver.find_elements_by_xpath('//*[@resource-id="com.miui.home:id/workspace"]/android.widget.FrameLayout[2]/android.view.ViewGroup[1]/android.widget.FrameLayout[4]/android.widget.FrameLayout[1]/android.widget.FrameLayout[1]/android.widget.ImageView[1]')
            sleep(2)
            if len(share) != 0:
                print('分享按钮存在,检查通过')
                sleep(2)
...
#********************************************************************************************************************************
    def test_jingxi_visitor_tc042(self):
        ...
        driver.swipe(50,1300,50,600,1000)
        sleep(2)
        u=driver.find_elements_by_xpath('//*[@text="儿童硅胶餐垫套装"]')
        if len(u) != 0:
            print('需要兑换的商品存在，检查通过')
            sleep(2)
            u[0].click()
...
#************************************************************************************************************
    def test_jingxi_cartcheck_tc043(self):
        ...
        driver.swipe(50,1300,50,600,1000)
        sleep(2)
        u1=driver.find_elements_by_xpath('//*[@text="儿童硅胶餐垫套装"]')
        if len(u1) != 0:
            ...
            if len(add2b) != 0:
                ...
                if '1' in ch1:
                    ...
                    driver.press_keycode('4')
                    sleep(2)
                    u2=driver.find_elements_by_xpath('//*[@text="流光系列香薰蜡烛"]')
                    if len(u2) != 0:
...
#*******************************************************
    def test_wode_joinnio_tc048(self):
        ...
        sleep(2)
        #软件开发
        TouchAction(driver).tap(x=550,y=996).release().perform()
        sleep(4)
        now=time.strftime('%Y-%m-%d %H_%M_%S')
...
#*******************************************************
    def test_aiche_cityplan_tc049(self):
        ...
        sleep(3)
        for i in range(2):
            driver.swipe(50,1700,50,200,1000)
            sleep(2)
        ...
        if len(city) != 0:
            ...
            TouchAction(driver).tap(x=120,y=1936).release().perform()
            sleep(2)
...
#*******************************************************
    def test_aiche_rechargemap_tc050(self):
        ...
        if len(cmap) != 0:
            ...
            #760，773
            TouchAction(driver).tap(x=750,y=755).release().perform()
            sleep(4)
            """
            now=time.strftime('%Y-%m-%d %H_%M_%S')
...
#*******************************************************
    def test_aiche_milecalculator_tc051(self):
        ...
        for i in range(2):
            driver.swipe(50,1700,50,200,1000)
            sleep(2)
        driver.swipe(50,1700,50,1300,1000)    
        sleep(2)
...
#*******************************************************
    def test_aiche_es8content_tc052(self):
        ...
        if len(cmap) != 0:
            ...
            #driver.find_element_by_xpath('//*[@text="个性化"]').click()
            sleep(3)
