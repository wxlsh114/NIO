...
#version:android 8.0
#author: Sam Wang
#update date: created by Sam [2018-08-14]
...
from common_android8 import fun_myfansui_check
from common_android8 import fun_mywatchui_check
from common_android8 import fun_mypublishui_check
from common_android8 import bp_is_loggedin
from common_android8 import fun_getinfo
from common_android8 import bp_normalloginmp
from common_android8 import bp_is_loginshow
from common_android8 import fun_getloginmenu
from common_android8 import bp_is_plusexist
from common_android8 import bp_is_publishnowexist
from common_android8 import bp_is_openmultichatexist
from common_android8 import fun_findui_check
from common_android8 import fun_personalinfoui_check
from common_android8 import fun_scoredetailui_check
from common_android8 import fun_giftui_check
from common_android8 import fun_articleui_check
from common_android8 import fun_cartui_check
from common_android8 import fun_pgcui_check
from common_android8 import fun_articledetailui_check
from common_android8 import fun_giftorderui_check
from common_android8 import fun_giftorderdetailui_check
from common_android8 import fun_getjingxiloginmenu
...
class Weilai_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        desired_caps['deviceName'] = 'chiron'
        #desired_caps['udid'] = 'dbb9d5be'
...
#*******************************************************
    def test_wode_personalinfo_tc011(self):
        ...
        if c1 == True:
            ...
            sleep(3)
            save1=driver.find_elements_by_xpath('//*[contains(@text,"保存成功")]')
...
#*******************************************************
    def test_faxian_article_tc019(self):
        ...
        #driver.find_element_by_xpath('//*[@text="发现"]').click()
        #sleep(2)
        driver.swipe(50,1600,50,500,1000)
        sleep(2)
        driver.swipe(50,1600,50,500,1000)
        sleep(2)
        #检查文章的各个元素是否存在
...
#*******************************************************
    def test_jingxi_add2basket_tc022(self):
        ...
        for i in range(7):
            ...
            sleep(2)
        driver.swipe(50,1800,50,900,1000)
        sleep(2)
...
#*******************************************************
    def test_pengyou_nicknameheadicon_tc028(self):
        ...
        if '群聊' in t:
            ...
            driver.find_element_by_id('cn.com.weilaihui3:id/choose_bellow_button').click()
            sleep(2)
            driver.find_elements_by_id('com.miui.gallery:id/pick_num_indicator')[0].click()
            sleep(15)
            driver.find_element_by_id('cn.com.weilaihui3:id/navigation_back_icon').click()
            sleep(1)
            driver.find_element_by_id('cn.com.weilaihui3:id/toolbar_back_icon').click()
    ...
    def test_pengyou_im_tc036(self):
        ...
        if len(u) != 0:
            ...
            if len(cp) != 0:
                ...
                #sleep(1)
                #165,843
                #driver.tap([(105,1033)],1000)
                TouchAction(driver).tap(x=105,y=1033).release().perform()
                sleep(1)
                driver.hide_keyboard()
                sleep(1)
                #发送
...
#*******************************************************
    def test_jingxi_clearcart_tc044(self):
        ...
        for i in range(7):
            driver.swipe(50,1800,50,200,1000)
            sleep(2)
        driver.swipe(50,1800,50,1000,1000)
        sleep(2)
        u1=driver.find_elements_by_xpath('//*[@text="轻奢长柄伞"]')
        if len(u1) != 0:
            print('需要兑换的商品1存在，检查通过')
...
#*******************************************************
    def test_aiche_cityplan_tc049(self):
        ...
        if len(city) != 0:
            ...
            TouchAction(driver).tap(x=200,y=1934).release().perform()
            sleep(2)
...
#*******************************************************
    def test_aiche_rechargemap_tc050(self):
        ...
        if len(cmap) != 0:
            ...
            #760，773
            TouchAction(driver).tap(x=760,y=773).release().perform()
            sleep(4)
            """
            now=time.strftime('%Y-%m-%d %H_%M_%S')
...
#*******************************************************
    def test_aiche_es8content_tc052(self):
        ...
        if len(cmap) != 0:
            ...
            sleep(3)
            driver.find_element_by_xpath('//android.view.View[@text="个性化"]').click()
            sleep(3)
            driver.find_element_by_xpath('//android.view.View[@text="选装包"]').click()
            sleep(3)
            driver.find_element_by_xpath('//android.view.View[@text="附件"]').click()
            sleep(3)
            #分享图标
            share=driver.find_elements_by_id('cn.com.weilaihui3:id/iv_more')
            sleep(2)
