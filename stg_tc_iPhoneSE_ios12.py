...
from common_iPhoneSE_ios12_stg import fun_myfansui_check
from common_iPhoneSE_ios12_stg import fun_mywatchui_check
from common_iPhoneSE_ios12_stg import fun_mypublishui_check
from common_iPhoneSE_ios12_stg import bp_is_loggedin
from common_iPhoneSE_ios12_stg import fun_getinfo
from common_iPhoneSE_ios12_stg import bp_normalloginmp
from common_iPhoneSE_ios12_stg import bp_is_loginshow
from common_iPhoneSE_ios12_stg import fun_getloginmenu
from common_iPhoneSE_ios12_stg import bp_is_plusexist
from common_iPhoneSE_ios12_stg import bp_is_publishnowexist
from common_iPhoneSE_ios12_stg import bp_is_openmultichatexist
from common_iPhoneSE_ios12_stg import fun_findui_check
from common_iPhoneSE_ios12_stg import fun_personalinfoui_check
from common_iPhoneSE_ios12_stg import fun_scoredetailui_check
from common_iPhoneSE_ios12_stg import fun_giftui_check
from common_iPhoneSE_ios12_stg import fun_articleui_check
from common_iPhoneSE_ios12_stg import fun_cartui_check
from common_iPhoneSE_ios12_stg import fun_pgcui_check
#from common_iPhoneSE_ios12_stg import fun_articledetailui_check
#from common_iPhoneSE_ios12_stg import fun_giftorderui_check
from common_iPhoneSE_ios12_stg import fun_mygiftorderdetailui_check
from common_iPhoneSE_ios12_stg import fun_getjingxiloginmenu
from common_iPhoneSE_ios12_stg import bp_deleteaddress
#from common_iPhoneSE_ios12_stg import fun_pinch
#from common_iPhoneSE_ios12_stg import fun_zoom
#from common_iPhoneSE_ios12_stg import bp_is_initpicexist
from common_iPhoneSE_ios12_stg import fun_lightedui_check
from common_iPhoneSE_ios12_stg import fun_notlightedui_check
from common_iPhoneSE_ios12_stg import fun_mostsiteui_check
from common_iPhoneSE_ios12_stg import fun_activityui_check
from common_iPhoneSE_ios12_stg import fun_livecastui_check
from common_iPhoneSE_ios12_stg import bp_normalloginmp_carowner
from common_iPhoneSE_ios12_stg import bp_normalloginmp_notenoughscore
from common_iPhoneSE_ios12_stg import bp_normalloginmp_zeroscore
...
#*******************************************************
    def test_wode_publish_tc003(self):
        ...
        if c1==True:
            ...
            sleep(2)
            #+
            driver.execute_script("mobile: tap", {"touchCount":"1", "x":45, "y":254})
            sleep(2)
            #好
            ...
            if len(title) != 0 :
                ...
                sleep(0.5)
                now=time.strftime('%Y%m%d_%H%M%S')
                sf1='../../test_report/ios/'+now+'_errPublishText_R_stg_tc003.png'
                driver.get_screenshot_as_file(sf1)
            sleep(2)
...
#*******************************************************
    def test_wode_deletepublished_tc007(self):
        ...
        if len(p) != 0:
            driver.find_elements_by_xpath('//XCUIElementTypeStaticText[@name="车主多积分"]')[0].click()
            sleep(3)
...
#*******************************************************
    def test_wode_checkin_tc025(self):
        ...
        driver.find_element_by_accessibility_id('我的').click()
        sleep(2)
        name=driver.find_elements_by_ios_predicate('type == "XCUIElementTypeStaticText" AND name == "车主多积分"')
        if len(name) != 0:
            print('用户车主多积分已登录！')
            sleep(0.5)
        else:
...
#*********************************************************************************************
    def test_jingxi_zeroscore_tc083(self):
        ...
        #driver.execute_script("mobile: dragFromToForDuration",{"fromX":50,"fromY":300,"toX":50,"toY":450,"duration":1.0})
        sleep(3)
        u1=driver.find_elements_by_xpath('//XCUIElementTypeOther[@name="自动化专用纯积分 自动化专用纯积分 10000"]')
        ch1=driver.find_element_by_xpath('//XCUIElementTypeOther[@name="自动化专用纯积分 自动化专用纯积分 10000"]').get_attribute('visible')
        sleep(1)
        if len(u1) != 0 and ch1 == 'true':
            print('纯积分商品找到')
            sleep(2)
            driver.find_element_by_xpath('//XCUIElementTypeOther[@name="自动化专用纯积分 自动化专用纯积分 10000"]').click()
            sleep(9)
