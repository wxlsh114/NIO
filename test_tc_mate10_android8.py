...
#version:android 8.1
#author: Sam Wang
#update date: created by Sam [2018-09-14]
...
from common_mate10_android8 import fun_myfansui_check
from common_mate10_android8 import fun_mywatchui_check
from common_mate10_android8 import fun_mypublishui_check
from common_mate10_android8 import bp_is_loggedin
from common_mate10_android8 import fun_getinfo
from common_mate10_android8 import bp_normalloginmp
from common_mate10_android8 import bp_is_loginshow
from common_mate10_android8 import fun_getloginmenu
from common_mate10_android8 import bp_is_plusexist
from common_mate10_android8 import bp_is_publishnowexist
from common_mate10_android8 import bp_is_openmultichatexist
from common_mate10_android8 import fun_findui_check
from common_mate10_android8 import fun_personalinfoui_check
from common_mate10_android8 import fun_scoredetailui_check
from common_mate10_android8 import fun_giftui_check
from common_mate10_android8 import fun_articleui_check
from common_mate10_android8 import fun_cartui_check
from common_mate10_android8 import fun_pgcui_check
from common_mate10_android8 import fun_articledetailui_check
from common_mate10_android8 import fun_giftorderui_check
from common_mate10_android8 import fun_giftorderdetailui_check
from common_mate10_android8 import fun_getjingxiloginmenu
...
class Weilai_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #desired_caps['udid'] = 'UYT5T18504003754'
...
#Pre-conditions:用户已正常登录app/未登录
#Post-conditions:N/A
#Modify History:created by Sam [2018/10/22]
#*******************************************************
...
#Pre-conditions:用户已正常登录app
#Post-conditions:N/A
#Modify History:created by Sam [2018/10/17]
#*******************************************************
...
#*******************************************************
    def test_wode_joinnio_tc048(self):
        ...
        sleep(2)
        #软件开发
        TouchAction(driver).tap(x=540,y=870).release().perform()
        sleep(4)
        #允许
        allow=driver.find_elements_by_xpath('//*[contains(@text,"允许")]')
        if len(allow) != 0:
...
#*******************************************************
    def test_aiche_cityplan_tc049(self):
        ...
        sleep(9)
        for i in range(3):
            driver.swipe(50,1500,50,220,1000)
            sleep(2)
        sleep(2)
        ...
        if len(city) != 0:
            ...
            TouchAction(driver).tap(x=130,y=1710).release().perform()
            sleep(2)
...
#Pre-conditions:用户已正常登录app
#Post-conditions:N/A
#Modify History:created by Sam [2018/10/18]
#*******************************************************
    def test_aiche_milecalculator_tc051(self):
        ...
        if len(cmap) != 0:
            ...
            if '309' in res.text:
                ...
                driver.get_screenshot_as_file(sf3)
            sleep(2)
            driver.swipe(50,1500,50,1400,1000)
            sleep(2)
            #改变轮毂尺寸
...
#*******************************************************
    def test_aiche_es8content_tc052(self):
        ...
        if len(cmap) != 0:
            ...
            sleep(3)
            driver.find_element_by_xpath('//*[@text="选装包"]').click()
            sleep(3)
            driver.find_element_by_xpath('//*[@text="附件"]').click()
            sleep(3)
            #分享图标
            share=driver.find_elements_by_id('cn.com.weilaihui3:id/iv_more')
            sleep(2)
