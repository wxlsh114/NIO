...
#version:android 8.0
#author: Sam Wang
#update date: created by Sam [2018-09-25]
...
from common_mate9pro_android8 import fun_myfansui_check
from common_mate9pro_android8 import fun_mywatchui_check
from common_mate9pro_android8 import fun_mypublishui_check
from common_mate9pro_android8 import bp_is_loggedin
from common_mate9pro_android8 import fun_getinfo
from common_mate9pro_android8 import bp_normalloginmp
from common_mate9pro_android8 import bp_is_loginshow
from common_mate9pro_android8 import fun_getloginmenu
from common_mate9pro_android8 import bp_is_plusexist
from common_mate9pro_android8 import bp_is_publishnowexist
from common_mate9pro_android8 import bp_is_openmultichatexist
from common_mate9pro_android8 import fun_findui_check
from common_mate9pro_android8 import fun_personalinfoui_check
from common_mate9pro_android8 import fun_scoredetailui_check
from common_mate9pro_android8 import fun_giftui_check
from common_mate9pro_android8 import fun_articleui_check
from common_mate9pro_android8 import fun_cartui_check
from common_mate9pro_android8 import fun_pgcui_check
from common_mate9pro_android8 import fun_articledetailui_check
from common_mate9pro_android8 import fun_giftorderui_check
from common_mate9pro_android8 import fun_giftorderdetailui_check
from common_mate9pro_android8 import fun_getjingxiloginmenu
...
class Weilai_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        desired_caps['deviceName'] = 'LON-AL00'
        #desired_caps['udid'] = 'WGY0217C08007245'
    ...
    def test_wode_personalinfo_tc011(self):
        ...
        if c1 == True:
            ...
            if len(ph) != 0:
                print('拍照按钮存在')
                sleep(1)
                driver.find_element_by_xpath('//*[contains(@text,"拍照")]').click()
                sleep(1)
                #始终允许
            ...
            if len(pic) != 0:
                ...
                sleep(1)
                picbtn=driver.find_elements_by_xpath('//*[contains(@text,"相机")]')
                if len(picbtn) != 0:
                    print('手机相册可以正常调用')
                else:
            ...
            if len(save1) != 0:
                ...
                now=time.strftime('%Y-%m-%d %H_%M_%S')
                sf='../../test_report/android/'+now+'_errorSaveInfo_R_tc011.png'
...
#*******************************************************
    def test_jingxi_add2basket_tc022(self):
        ...
        driver.find_element_by_xpath('//*[@text="惊喜"]').click()
        sleep(6)
        driver.swipe(50,1300,50,700,1000)
        sleep(2)
        u=driver.find_elements_by_xpath('//*[@text="ES8创始版1:18车模"]')
        if len(u) != 0:
            print('需要兑换的商品存在，检查通过')
            sleep(2)
            driver.find_element_by_xpath('//android.widget.TextView[@text="ES8创始版1:18车模"]').click()
            sleep(9)
            ...
            if chk == True:
                ...
                try:
                    ...
                    if len(chk) == 0:
                        ...
                        sleep(6)
                        #检查商品状态
                        chk1=driver.find_elements_by_xpath('//*[@text="ES8创始版1:18车模"]')
                        chk2=driver.find_elements_by_xpath('//*[@text="待发货"]')
                        sleep(1)
...
#*******************************************************
    def test_faxian_expershowpic_tc032(self):
        ...
        driver.find_element_by_xpath('//*[@text="徐家汇活动之还未开始"]').click()
        sleep(8)
        #print(driver.page_source)
        page=driver.page_source
        sleep(2)
...
#*******************************************************
    def test_pengyou_im_tc036(self):
        ...
        if len(u) != 0:
            driver.find_elements_by_id('cn.com.weilaihui3:id/tv_name')[2].click()
            sleep(3)
            #聊天
            driver.find_element_by_id('cn.com.weilaihui3:id/user_info_submit_btn').click()
            sleep(2)
            ...
            if len(cp) != 0:
                ...
                #sleep(1)
                TouchAction(driver).tap(x=170,y=1230).release().perform()
                sleep(1)
                driver.hide_keyboard()
                sleep(1)
                #发送
...
#*******************************************************
    def test_faxian_experjoin_tc038(self):
        ...
        sleep(2)
        driver.swipe(50,2000,50,300,1000)
        sleep(2)
        #自动化测试活动
        ...
        if len(joins) != 0:
            ...
            driver.hide_keyboard()
            sleep(3)
            #性别*[@resource-id="app"]/android.view.View[1]/
            driver.find_element_by_xpath('//android.view.View[2]/android.view.View[4]/android.view.View[2]/android.view.View[1]').click()
            sleep(1)
            #完成
            driver.find_element_by_id('cn.com.weilaihui3:id/data_selector_ok').click()
            sleep(2)
            #血型
            driver.find_element_by_xpath('//android.view.View[2]/android.view.View[5]/android.view.View[2]/android.view.View[1]').click()
            sleep(1)
            #完成
            driver.find_element_by_id('cn.com.weilaihui3:id/data_selector_ok').click()
            sleep(2)
            #证件类型
            driver.find_element_by_xpath('//android.view.View[2]/android.view.View[6]/android.view.View[2]/android.view.View[1]').click()
            sleep(1)
            #完成
            driver.find_element_by_id('cn.com.weilaihui3:id/data_selector_ok').click()
            sleep(1)
...
#*******************************************************
    def test_faxian_expershare_tc040(self):
        ...
        sleep(3)
        #分享图标
        share=driver.find_elements_by_xpath('//android.webkit.WebView[1]/android.view.View[1]/android.view.View[2]')
        sleep(2)
        if len(share) != 0:
            print('分享按钮存在,检查通过')
            sleep(2)
...
#*******************************************************
    def test_aiche_cityplan_tc049(self):
        ...
        sleep(9)
        for i in range(3):
            driver.swipe(50,2000,50,200,1000)
            sleep(2)
        sleep(2)
        ...
        if len(city) != 0:
            ...
            TouchAction(driver).tap(x=168,y=2436).release().perform()
            sleep(2)
...
#*******************************************************
    def test_aiche_rechargemap_tc050(self):
        ...
        if len(cmap) != 0:
            ...
            TouchAction(driver).tap(x=1040,y=907).release().perform()
            sleep(4)
            """
            now=time.strftime('%Y-%m-%d %H_%M_%S')
