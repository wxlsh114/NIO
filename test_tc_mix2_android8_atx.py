...
from common_android8_atx import fun_myfansui_check
from common_android8_atx import fun_mywatchui_check
from common_android8_atx import fun_mypublishui_check
from common_android8_atx import bp_is_loggedin
from common_android8_atx import fun_getinfo
from common_android8_atx import bp_normalloginmp
from common_android8_atx import bp_is_loginshow
from common_android8_atx import fun_getloginmenu
from common_android8_atx import bp_is_plusexist
from common_android8_atx import bp_is_publishnowexist
from common_android8_atx import bp_is_openmultichatexist
from common_android8_atx import fun_findui_check
from common_android8_atx import fun_personalinfoui_check
from common_android8_atx import fun_scoredetailui_check
from common_android8_atx import fun_giftui_check
from common_android8_atx import fun_articleui_check
from common_android8_atx import fun_cartui_check
from common_android8_atx import fun_pgcui_check
from common_android8_atx import fun_articledetailui_check
from common_android8_atx import fun_giftorderui_check
from common_android8_atx import fun_giftorderdetailui_check
from common_android8_atx import fun_getjingxiloginmenu

import uiautomator2 as u2
#d=u2.connect('dbb9d5be')
...
#*******************************************************
    def test_jingxi_add2basket_tc022(self):
        ...
        d.xpath('//*[@text="惊喜"]').click()
        sleep(6)
        d.swipe(50,1300,50,500,1.0)
        sleep(2)
        u=d.xpath('//*[@text="儿童硅胶餐垫套装"]')
        if u.exists:
            print('需要兑换的商品存在，检查通过')
            sleep(2)
            d.xpath('//android.widget.TextView[@text="儿童硅胶餐垫套装"]').click()
            sleep(9)
            page=d.info
            sleep(2)
            #加入购物车
            ...
            if chk == True:
                ...
                try:
                    ...
                    if chk.exists:
                        ...
                        sleep(6)
                        #检查商品状态
                        chk1=d.xpath('//*[@text="儿童硅胶餐垫套装"]')
                        chk2=d.xpath('//*[@text="已付款"]')
                        sleep(1)
...
#Pre-conditions:用户已正常登录app
#Post-conditions:N/A
#Modify History:created by Sam [2018/10/16]
#*******************************************************
    ...
    def test_jingxi_cartcheck_tc043(self):
        ...
        if u1.exists:
            ...
            if add2b.exists:
                ...
                sleep(3)
                #购物车角标
                ch1=d(text='1', className='android.view.View', instance=1)
                if ch1.exists:
                    ...
                    if u2.exists:
                        ...
                        sleep(3)
                        #购物车角标
                        ch2=d.xpath('//android.view.View[@text="2"]')
                        if ch2.exists:
