#coding=utf-8
#test purpose: verify the main features on OnePlus
#os: Android
#device: 5T
#version:android 8.1
#author: Sam Wang
#update date: created by Sam [2018-09-05]
...
from common_oneplus_android8 import fun_myfansui_check
from common_oneplus_android8 import fun_mywatchui_check
from common_oneplus_android8 import fun_mypublishui_check
from common_oneplus_android8 import bp_is_loggedin
from common_oneplus_android8 import fun_getinfo
from common_oneplus_android8 import bp_normalloginmp
from common_oneplus_android8 import bp_is_loginshow
from common_oneplus_android8 import fun_getloginmenu
from common_oneplus_android8 import bp_is_plusexist
from common_oneplus_android8 import bp_is_publishnowexist
from common_oneplus_android8 import bp_is_openmultichatexist
from common_oneplus_android8 import fun_findui_check
from common_oneplus_android8 import fun_personalinfoui_check
from common_oneplus_android8 import fun_scoredetailui_check
from common_oneplus_android8 import fun_giftui_check
from common_oneplus_android8 import fun_articleui_check
from common_oneplus_android8 import fun_cartui_check
from common_oneplus_android8 import fun_pgcui_check
from common_oneplus_android8 import fun_articledetailui_check
from common_oneplus_android8 import fun_giftorderui_check
from common_oneplus_android8 import fun_giftorderdetailui_check
from common_oneplus_android8 import fun_getjingxiloginmenu
...
class Weilai_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        desired_caps['deviceName'] = 'OnePlus5T'
        #desired_caps['udid'] = 'dc3d5227'
...
#*******************************************************
    def test_jingxi_add2basket_tc022(self):
        ...
        driver.find_element_by_xpath('//*[@text="惊喜"]').click()
        sleep(6)
        driver.swipe(50,1200,50,600,1000)
        sleep(2)
...
#*******************************************************
    def test_pengyou_nicknameheadicon_tc028(self):
        ...
        if '群聊' in t:
            ...
            driver.find_element_by_id('cn.com.weilaihui3:id/choose_up_button').click()
            sleep(2)
            driver.find_element_by_id('com.oneplus.camera:id/switch_camera_button').click()
            sleep(3)
            #com.oneplus.camera:id/primary_capture_button
            driver.find_element_by_xpath('//android.widget.ImageButton[@content-desc="拍照"]').click()
            sleep(3)
            driver.find_element_by_id('com.oneplus.camera:id/review_ok_button').click()
            sleep(15)
            #修改头像
            driver.find_element_by_id('cn.com.weilaihui3:id/group_header').click()
            sleep(2)
            ...
            driver.find_element_by_id('cn.com.weilaihui3:id/choose_bellow_button').click()
            sleep(2)
            driver.find_element_by_xpath('//*[@text="所有照片"]').click()
            sleep(2)
            #driver.tap([(158,360)],2000)
            #not working
            driver.find_elements_by_class_name('android.widget.Button')[0].click()
            sleep(2)
            #driver.find_element_by_xpath('//*[@content-desc="完成"]').click()
            sleep(13)
            driver.find_element_by_id('cn.com.weilaihui3:id/navigation_back_icon').click()
            sleep(2)
            driver.find_element_by_id('cn.com.weilaihui3:id/toolbar_back_icon').click()
    ...
    def test_faxian_publishnowatfriend_tc033(self):
        ...
        if c1 == True:
            ...
            if c2 == True:
                ...
                sleep(1)
                driver.find_element_by_xpath('//*[@text="Sam8203"]').click()
                sleep(1)
                driver.find_element_by_xpath('//*[@text="发布"]').click()
                sleep(9)
                #check numbers of pictures and published text here
                ...
                mobile_no.click()
                sleep(1)
                mobile_no.send_keys('98762648203')
                sleep(1)
                code=driver.find_element_by_id('cn.com.weilaihui3:id/login_main_login_code_edit')
                code.click()
                sleep(1)
    ...
    def test_pengyou_im_tc036(self):
        ...
        if len(u) != 0:
            ...
            if len(cp) != 0:
                ...
                word.click()
                sleep(1)
                TouchAction(driver).long_press(word,duration=500).release().perform()
                sleep(1)
                #165,843
                driver.tap([(158,1023)],1000)
                sleep(1)
                driver.hide_keyboard()
                sleep(1)
                driver.find_element_by_id('cn.com.weilaihui3:id/rc_send_toggle').click()
...
#*******************************************************
    def test_faxian_experjoin_tc038(self):
        ...
        sleep(2)
        driver.swipe(50,1500,50,1000,1000)
        sleep(2)
...
#*******************************************************
    def test_aiche_cityplan_tc049(self):
        ...
        if len(city) != 0:
            ...
            TouchAction(driver).tap(x=129,y=1935).release().perform()
            sleep(2)
...
#*******************************************************
    def test_aiche_rechargemap_tc050(self):
        ...
        if len(cmap) != 0:
            ...
            TouchAction(driver).tap(x=750,y=771).release().perform()
            sleep(4)
            """
            now=time.strftime('%Y-%m-%d %H_%M_%S')
        ...
        if len(cmap) != 0:
            ...
            if len(share) != 0:
                ...
                if len(wb) != 0:
                    ...
                    #driver.find_element_by_xpath('//android.widget.TextView[@content-desc="发送"]').click()
                    #990,124
                    TouchAction(driver).tap(x=990,y=124).release().perform()
                    sleep(1)
                    #检查toast
                    save3=driver.find_elements_by_xpath('//*[contains(@text,"分享成功")]')
                    save3a=driver.find_elements_by_xpath('//*[contains(@text,"不错呀")]')
