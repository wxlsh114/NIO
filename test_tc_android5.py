...
from common_android5 import fun_myfansui_check
from common_android5 import fun_mywatchui_check
from common_android5 import fun_mypublishui_check
from common_android5 import bp_is_loggedin
from common_android5 import fun_getinfo
from common_android5 import bp_normalloginmp
from common_android5 import bp_is_loginshow
from common_android5 import fun_getloginmenu
from common_android5 import bp_is_plusexist
from common_android5 import bp_is_publishnowexist
from common_android5 import bp_is_openmultichatexist
from common_android5 import fun_findui_check
from common_android5 import fun_personalinfoui_check
from common_android5 import fun_scoredetailui_check
from common_android5 import fun_giftui_check
from common_android5 import fun_articleui_check
from common_android5 import fun_cartui_check
from common_android5 import fun_pgcui_check
from common_android5 import fun_articledetailui_check
from common_android5 import fun_getjingxiloginmenu
...
#*******************************************************
    def test_wode_loginwechat_tc008(self):
        ...
        if len(btn) != 0:
            ...
            sleep(9)
            #driver.find_element_by_android_uiautomator('new UiSelector().text("确认登录")').click()
            sleep(5)
            name=driver.find_element_by_id('cn.com.weilaihui3:id/my_head_info_user_name')
            if '王若妍' in name.text:
                print('微信登录成功！')
    ...
    def test_wode_personalinfo_tc011(self):
        ...
        if c1 == True:
            ...
            if len(ph) != 0:
                ...
                phbtn=driver.find_elements_by_xpath('//android.widget.ImageView[@content-desc="拍摄"]')
                sleep(2)
                if len(phbtn) != 0:
                    print('手机相机已正常弹出')
                else:
            ...
            if len(pic) != 0:
                ...
                #driver.press_keycode('4')
                #取消
                driver.find_element_by_xpath('//android.widget.Button[@text="取消"]').click()
                sleep(2)
            else:
            ...
            sleep(3)
            ct=driver.find_elements_by_xpath('//*[@text="天津市"]')
            if len(ct) != 0:
                print('常驻地区页面可以进入')
            else:
            ...
            sleep(3)
            addr=driver.find_elements_by_xpath('//*[@text="设为默认地址"]')
            if len(addr) != 0:
                print('地址管理页面可以进入')
            else:
...
#*******************************************************************
    def test_pengyou_dismissmultichat_tc021(self):
        ...
        if len(mul) != 0:
            ...
            now=time.strftime('%Y-%m-%d %H_%M_%S')
            sf4='../../test_report/'+now+'_errorNoMultiChat_R.png'
...
#*******************************************************
    def test_pengyou_nicknameheadicon_tc028(self):
        ...
        if '群聊' in t:
            ...
            try:
                #前后置切换
                driver.find_element_by_id('com.android.camera:id/v6_camera_picker').click()
                sleep(2)
                driver.find_element_by_id('com.android.camera:id/v6_shutter_button_internal').click()
                sleep(3)
                #driver.find_element_by_xpath('//android.widget.ImageView[@content-desc="Done"]').click()
                driver.find_element_by_id('com.android.camera:id/v6_btn_done').click()
                sleep(15)
            except Exception as e:
                print('发生异常：'+str(e))
                sleep(1)
            ...
            sleep(2)
            driver.find_elements_by_id('com.miui.gallery:id/micro_thumb')[1].click()
            sleep(15)
            driver.find_element_by_id('cn.com.weilaihui3:id/navigation_back_icon').click()
            sleep(2)
            driver.find_element_by_id('cn.com.weilaihui3:id/toolbar_back_icon').click()
...
#************************************************************************************************************
    def test_jingxi_cartcheck_tc043(self):
        ...
        driver.find_element_by_xpath('//*[@text="惊喜"]').click()
        sleep(6)
        driver.swipe(50,1300,50,1000,1000)
        sleep(2)
