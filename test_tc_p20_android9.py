...
from common_p20_android9 import fun_myfansui_check
from common_p20_android9 import fun_mywatchui_check
from common_p20_android9 import fun_mypublishui_check
from common_p20_android9 import bp_is_loggedin
from common_p20_android9 import fun_getinfo
from common_p20_android9 import bp_normalloginmp
from common_p20_android9 import bp_is_loginshow
from common_p20_android9 import fun_getloginmenu
from common_p20_android9 import bp_is_plusexist
from common_p20_android9 import bp_is_publishnowexist
from common_p20_android9 import bp_is_openmultichatexist
from common_p20_android9 import fun_findui_check
from common_p20_android9 import fun_personalinfoui_check
from common_p20_android9 import fun_scoredetailui_check
from common_p20_android9 import fun_giftui_check
from common_p20_android9 import fun_articleui_check
from common_p20_android9 import fun_cartui_check
from common_p20_android9 import fun_pgcui_check
from common_p20_android9 import fun_articledetailui_check
from common_p20_android9 import fun_giftorderui_check
from common_p20_android9 import fun_giftorderdetailui_check
from common_p20_android9 import fun_getjingxiloginmenu
...
#*********************************************************************************************
    def test_jingxi_add2basket_tc022(self):
        ...
        sleep(6)
        for i in range(7):
            driver.swipe(50,1900,50,200,1000)
            sleep(2)
            ...
            if chk == True:
                ...
                try:
                    ...
                    if len(chk) == 0:
                        ...
                        sleep(6)
                        #检查商品状态
                        chk1=driver.find_elements_by_xpath('//*[@text="轻奢长柄伞"]')
...
#*******************************************************
    def test_faxian_expershowpic_tc032(self):
        ...
        sleep(2)
        #晒图
        show=driver.find_elements_by_xpath('//android.webkit.WebView[1]/android.view.View[1]/android.view.View[19]/android.view.View[2]')
        sleep(2)
        if len(show) != 0:
            print('晒图按钮存在,检查通过')
            sleep(2)
...
#*******************************************************
    def test_jingxi_giftshare_tc041(self):
        ...
        driver.swipe(50,1900,50,1400,1000)
        sleep(2)
        u1=driver.find_elements_by_xpath('//*[@text="轻奢长柄伞"]')
        if len(u1) != 0:
            print('需要兑换的商品存在，检查通过')
            sleep(2)
            u[0].click()
        ...
        if len(u1) != 0:
            ...
            if len(add2b) != 0:
                ...
                if '1' in ch1:
                    ...
                    driver.press_keycode('4')
                    sleep(2)
                    u2=driver.find_elements_by_xpath('//*[@text="BeatsX无线蓝牙耳机"]')
                    if len(u2) != 0:
