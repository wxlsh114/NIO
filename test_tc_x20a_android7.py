#coding=utf-8
#test purpose: verify the main features on Vivo
#os: Android
#device: Vivo X20A
#version:android 7.1
#author: Sam Wang
...
class Weilai_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        desired_caps['deviceName'] = 'PD1709'
        #desired_caps['udid'] = '86bcaaf'
...
#*******************************************************
    def test_wode_watch_tc002(self):
        ...
        if len(n) == 0:
            ...
            now=time.strftime('%Y-%m-%d %H_%M_%S')
            sf1='../test_report/'+now+'_errorCancelCare_R.png'
...
#*******************************************************
    def test_wode_publish_tc003(self):
        ...
        if 'I love Shanghai#发布#'+now0 in title.text:
            ...
            now=time.strftime('%Y-%m-%d %H_%M_%S')
            sf1='../test_report/'+now+'_errorPublishText_R.png'
            driver.get_screenshot_as_file(sf1)
        sleep(1)
        ...
        if '9' in number.text:
            ...
            now=time.strftime('%Y-%m-%d %H_%M_%S')
            sf2='../test_report/'+now+'_errorPublishPicture9_R.png'
            driver.get_screenshot_as_file(sf2)
        sleep(1)
        driver.press_keycode('4')
        sleep(2)
...
#*******************************************************
    def test_wode_reloginmp_tc004(self):
        ...
        if 'Sam8201' in name.text:
            ...
            print('登录失败！')
            now=time.strftime('%Y-%m-%d %H_%M_%S')
            sf='../test_report/'+now+'_errorLoginMP_R.png'
...
#*******************************************************
    def test_wode_visitor_tc005(self):
        ...
        if len(tl) == 0:
            ...
            now=time.strftime('%Y-%m-%d %H_%M_%S')
            sf0='../test_report/'+now+'_errorJoinNIO_R.png'
        ...
        if len(out) != 0:
            ...
            now=time.strftime('%Y-%m-%d %H_%M_%S')
            sf1='../test_report/'+now+'_errorSettings_R.png'
            driver.get_screenshot_as_file(sf1)
        else:
        ...
        try:
            ...
            print('Something wrong happened when loggining!')
            #home
        ...
        if c1 == True:
            ...
            if c2 == True:
                ...
                if 'I love Shanghai#'+now0 in title.text:
                    ...
                    print('发布内容的文字检查失败，请检查原因')
                    now=time.strftime('%Y-%m-%d %H_%M_%S')
                    sf1='../test_report/'+now+'_errorText_R.png'
                    driver.get_screenshot_as_file(sf1)
                sleep(1)
                number=driver.find_element_by_id('cn.com.weilaihui3:id/ugc_list_three_img_num')
                #print(number.text)
                if '9' in number.text:
                    ...
                    print('发布内容的上传9张图片检查失败，请检查原因')
                    now=time.strftime('%Y-%m-%d %H_%M_%S')
                    sf2='../test_report/'+now+'_errorPic9_R.png'
                    driver.get_screenshot_as_file(sf2)
                sleep(1)
                driver.press_keycode('4')
                sleep(1)
    ...
    def test_wode_deletepublished_tc007(self):
        ...
        if len(p)!=0:
            ...
            if len(ch)!=0:
                ...
                now=time.strftime('%Y-%m-%d %H_%M_%S')
                sf1='../test_report/'+now+'_errorDeleted_R.png'
                driver.get_screenshot_as_file(sf1)
            else:
                print('发布的内容删除成功')
            sleep(1)
    ...
    def test_wode_loginwechat_tc008(self):
        ...
        if len(btn) != 0:
            ...
            if '王若妍' in name.text:
                ...
                print('微信登录失败！')
                now=time.strftime('%Y-%m-%d %H_%M_%S')
                sf0='../test_report/'+now+'_errorLoginWechat_R.png'
                driver.get_screenshot_as_file(sf0)
            sleep(1)
        else:
        ...
        if c1 == True:
            ...
            if len(ph) != 0:
                ...
                if len(allow) != 0:
                    driver.find_element_by_xpath('//*[@text="允许"]').click()
                    sleep(2)
                phbtn=driver.find_elements_by_xpath('//*[@text="拍照"]')
                if len(phbtn) != 0:
                    print('手机相机已正常弹出')
                else:
            ...
            if len(pic) != 0:
                ...
                if len(allow) != 0:
                    ...
                    sleep(2)
                #相机
                picbtn=driver.find_elements_by_id('com.vivo.gallery:id/dreamway_folder_name')
                if len(picbtn) != 0:
                    print('手机相册可以正常调用')
                else:
    ...
    def test_faxian_article_tc019(self):
        ...
        if c1 == True:
            ...
            if 'I like this article#'+now0 in title.text:
                ...
                now=time.strftime('%Y-%m-%d %H_%M_%S')
                sf1='../test_report/'+now+'_errorComment_R.png'
                driver.get_screenshot_as_file(sf1)
            sleep(1)
        driver.press_keycode('4')
        sleep(2)
...
#*********************************************************************************************
    def test_jingxi_add2basket_tc022(self):
        ...
        sleep(6)
        for i in range(6):
            driver.swipe(50,1700,50,270,1000)
            sleep(2)
        sleep(2)
...
#****************************************************************************************************
    def test_pengyou_searchwatch_tc029(self):
        ...
        if len(add) != 0:
            ...
            sleep(1)
            #手动点search
            #driver.tap([(985,1942)],500)
            TouchAction(driver).tap(x=985,y=1942).release().perform()
            sleep(2)
    ...
    def test_pengyou_im_tc036(self):
        ...
        if len(u) != 0:
            ...
            if len(cp) != 0:
                ...
                sleep(1)
                TouchAction(driver).tap(x=114,y=993).release().perform()
                sleep(1)
                driver.hide_keyboard()
                sleep(1)
                driver.find_element_by_id('cn.com.weilaihui3:id/rc_send_toggle').click()
...
#*******************************************************
    def test_faxian_experjoin_tc038(self):
        ...
        if len(joins) != 0:
            ...
            sleep(4)
            #场次
            #driver.find_element_by_xpath('//*[contains(@text,"10.24")]').click()
            #sleep(1)
...
#*******************************************************
    def test_jingxi_giftshare_tc041(self):
        ...
        driver.find_element_by_xpath('//*[@text="惊喜"]').click()
        sleep(8)
        driver.swipe(50,1300,50,420,1000)
        sleep(2)
        u=driver.find_elements_by_xpath('//*[@text="轻奢长柄伞"]')
        if len(u) != 0:
            print('需要兑换的商品存在，检查通过')
        ...
        if len(u1) != 0:
            ...
            if len(add2b) != 0:
                ...
                if '1' in ch1:
                    ...
                    driver.press_keycode('4')
                    sleep(2)
                    u2=driver.find_elements_by_xpath('//*[@text="蔚来Blue Sky鲜花盒"]')
                    if len(u2) != 0:
...
#*******************************************************
    def test_wode_joinnio_tc048(self):
        ...
        TouchAction(driver).tap(x=540,y=744).release().perform()
        sleep(6)
        #page=driver.page_source
        #sleep(2)
        #软件开发
        TouchAction(driver).tap(x=540,y=1022).release().perform()
        sleep(4)
        now=time.strftime('%Y-%m-%d %H_%M_%S')
...
#*******************************************************
    def test_aiche_cityplan_tc049(self):
        ...
        if len(city) != 0:
            ...
            TouchAction(driver).tap(x=126,y=1938).release().perform()
            sleep(2)
...
#*******************************************************
    def test_aiche_rechargemap_tc050(self):
        ...
        if len(cmap) != 0:
            ...
            #760，773
            TouchAction(driver).tap(x=784,y=737).release().perform()
            sleep(4)
            """
            now=time.strftime('%Y-%m-%d %H_%M_%S')
