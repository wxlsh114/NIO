...
#version:android 8.1
#author: Sam Wang
#update date: created by Sam [2018-09-06]
...
from common_p20_android8 import fun_myfansui_check
from common_p20_android8 import fun_mywatchui_check
from common_p20_android8 import fun_mypublishui_check
from common_p20_android8 import bp_is_loggedin
from common_p20_android8 import fun_getinfo
from common_p20_android8 import bp_normalloginmp
from common_p20_android8 import bp_is_loginshow
from common_p20_android8 import fun_getloginmenu
from common_p20_android8 import bp_is_plusexist
from common_p20_android8 import bp_is_publishnowexist
from common_p20_android8 import bp_is_openmultichatexist
from common_p20_android8 import fun_findui_check
from common_p20_android8 import fun_personalinfoui_check
from common_p20_android8 import fun_scoredetailui_check
from common_p20_android8 import fun_giftui_check
from common_p20_android8 import fun_articleui_check
from common_p20_android8 import fun_cartui_check
from common_p20_android8 import fun_pgcui_check
from common_p20_android8 import fun_articledetailui_check
from common_p20_android8 import fun_giftorderui_check
from common_p20_android8 import fun_giftorderdetailui_check
from common_p20_android8 import fun_getjingxiloginmenu
...
class Weilai_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        desired_caps['deviceName'] = 'EML-AL00'
        #desired_caps['udid'] = 'CLB0218620005840'
...
#Post-conditions:N/A
#Modify History:created by Sam [2018/09/05]
#*******************************************************
...
#*******************************************************
    def test_wode_publish_tc003(self):
        ...
        sleep(10)
        #refresh
        driver.swipe(100,300,100,700,2000)
        sleep(2)
...
#*******************************************************
    def test_wode_visitor_tc005(self):
        ...
        sleep(1)
        driver.swipe(50,900,50,1030,1000)
        sleep(1)
        ...
        try:
            ...
            print('Something wrong happened when loggining!----'+str(e))
            #home
...
#*******************************************************
    def test_faxian_publishnow_tc006(self):
        ...
        if c1 == True:
            ...
            if c2 == True:
                driver.find_element_by_xpath('//*[@text="发此刻"]').click()
                sleep(2)
                driver.find_element_by_id('cn.com.weilaihui3:id/image').click()
                sleep(2)
                #始终允许
...
#*******************************************************
    def test_wode_instuninstversioncheck_tc015(self):
        ...
        if c == True:
            ...
            sleep(1)
            #继续安装
            inst=driver.find_elements_by_xpath('//*[contains(@text,"安装")]')
            if len(inst) != 0:
                driver.find_element_by_xpath('//*[contains(@text,"安装")]').click()
                sleep(5)
            ...
            #允许
            sleep(4)
            allow=driver.find_elements_by_xpath('//*[contains(@text,"始终允许")]')
            if len(allow) != 0:
...
#*******************************************************
    def test_faxian_openmultichat_tc020(self):
        ...
        if c1 == True:
            ...
            if c2 == True:
                driver.find_element_by_xpath('//*[@text="建群聊"]').click()
                sleep(3)
...
#*******************************************************************
    def test_pengyou_dismissmultichat_tc021(self):
        ...
        if len(mul) != 0:
            ...
            sleep(3)
            #邀请
            ask=driver.find_elements_by_xpath('//*[contains(@text,"邀请")]')
            if len(ask) != 0:
                driver.find_element_by_xpath('//*[contains(@text,"邀请")]').click()
            sleep(2)
            driver.find_element_by_id('cn.com.weilaihui3:id/navigation_back_icon').click()
            sleep(2)
            #检查是否已被邀请加入群组
            ...
            sleep(2)
            #检查解散的群聊是否还存在
            #title1=driver.find_elements_by_id('cn.com.weilaihui3:id/item_name_layout')[1]
...
#Pre-conditions:用户已正常登录app
#Post-conditions:N/A
#Modify History:created by Sam [2018/09/16]
#*********************************************************************************************
    def test_jingxi_add2basket_tc022(self):
        ...
        sleep(6)
        for i in range(5):
            driver.swipe(50,1900,50,150,1000)
            sleep(2)
        #driver.swipe(50,1900,50,1400,1000)
        sleep(2)
        u1=driver.find_elements_by_xpath('//*[@text="Blue Sky 小咖杯"]')
        if len(u1) != 0:
            print('需要兑换的商品存在，检查通过')
            sleep(2)
            driver.find_element_by_xpath('//*[@text="Blue Sky 小咖杯"]').click()
            sleep(8)
            ...
            if chk == True:
                ...
                try:
                    ...
                    if len(chk) == 0:
                        ...
                        sleep(6)
                        #检查商品状态
                        chk1=driver.find_elements_by_xpath('//*[@text="Blue Sky 小咖杯"]')
...
#*******************************************************
    def test_pengyou_nicknameheadicon_tc028(self):
        ...
        if len(mul) != 0:
            ...
            driver.find_element_by_id('cn.com.weilaihui3:id/choose_up_button').click()
            sleep(2)
            sw=driver.find_elements_by_xpath('//*[@content-desc="切换到后置摄像头"]')
            if len(sw) == 0:
                driver.find_element_by_id('com.huawei.camera:id/iv_normal_control_bar_switcher_single').click()
                sleep(3)
            ...
            driver.find_element_by_id('cn.com.weilaihui3:id/choose_bellow_button').click()
            sleep(2)
            driver.find_element_by_xpath('//*[@text="pconlinedownload"]').click()
            sleep(2)
            TouchAction(driver).tap(x=158,y=360).release().perform()
            sleep(1)
...
#*******************************************************
    def test_faxian_expershowpic_tc032(self):
        ...
        sleep(2)
        #晒图
        show=driver.find_elements_by_xpath('//android.webkit.WebView[1]/android.view.View[1]/android.view.View[22]/android.view.View[2]')
        sleep(2)
        if len(show) != 0:
            print('晒图按钮存在,检查通过')
            sleep(2)
    ...
    def test_faxian_publishnowatfriend_tc033(self):
        ...
        if c1 == True:
            ...
            if c2 == True:
                ...
                title=driver.find_elements_by_id('cn.com.weilaihui3:id/ugc_list_content')[0]
                #print(title.text)
                if '人生苦短我用Python'+now0 in title.text:
                    print('发布内容的文字检查通过')
                else:
                    print('发布内容的文字检查失败，请检查原因')
                    now=time.strftime('%Y-%m-%d %H_%M_%S')
    ...
    def test_faxian_ugcshare_tc034(self):
        ...
        if len(u) != 0:
            ...
            if len(mf) != 0:
                ...
                sleep(3)
                #2nd friend
                driver.find_elements_by_id('cn.com.weilaihui3:id/tv_name')[1].click()
                sleep(1)
                #检查toast
...
#*******************************************************
    def test_pengyou_im_tc036(self):
        ...
        if len(u) != 0:
            ...
            TouchAction(driver).long_press(d,duration=500).release().perform()
            sleep(1)
            #复制消息
            ...
            if len(cp) != 0:
                ...
                word.click()
                sleep(1)
                TouchAction(driver).long_press(word,duration=100).release().perform()
                sleep(1)
                #165,843
                #driver.tap([(158,1180)],1000)
                TouchAction(driver).tap(x=158,y=1180).release().perform()
                sleep(1)
                driver.hide_keyboard()
                sleep(1)
                driver.find_element_by_id('cn.com.weilaihui3:id/rc_send_toggle').click()
...
#Pre-conditions:用户已正常登录app
#Post-conditions:N/A
#Modify History:created by Sam [2018/09/03]
#*******************************************************
    def test_faxian_experjoin_tc038(self):
        ...
        driver.find_element_by_id('cn.com.weilaihui3:id/loi_cur_store_tip').click()
        sleep(2)
        driver.swipe(50,1800,50,1300,1000)
        sleep(2)
        driver.find_element_by_xpath('//android.widget.TextView[@text="蔚来上海三号店"]').click()
        sleep(2)
        driver.swipe(50,1800,50,800,1000)
        sleep(2)
        """
        driver.find_element_by_xpath('//*[@text="更多活动"]').click()
        sleep(2)
        for i in range(2):
            driver.swipe(50,1900,50,300,1000)
            sleep(2)
        driver.swipe(50,1800,50,1300,1000)
        sleep(2)
        """
        #自动化测试活动
        #driver.find_element_by_id('cn.com.weilaihui3:id/activity_list_item_title').click()
        act=driver.find_elements_by_xpath('//*[@text="自动化测试活动1"]')
        if len(act) != 0:
            print('报名活动已找到')
            sleep(1)
            driver.find_element_by_xpath('//*[@text="自动化测试活动1"]').click()
            sleep(6)
            page=driver.page_source
            sleep(2)
            #报名
            joins=driver.find_elements_by_xpath('//android.webkit.WebView[1]/android.view.View[1]/android.view.View[16]/android.view.View[2]')
            sleep(2)
            if len(joins) != 0:
                print('报名按钮存在,检查通过')
                sleep(2)
                ...
                #场次
                #driver.find_element_by_xpath('//*[contains(@text,"11.29")]').click()
                #sleep(1)
                #driver.find_element_by_xpath('//*[contains(@text,"稍等哈活动")]').click()
                #sleep(2)
                #+限购1张
                ...
                if len(ch) == 0:
                    ...
                    sleep(2)
                    ch2=driver.find_elements_by_xpath('//android.widget.TextView[contains(@text,"11月29日")]')
                    if len(ch2) != 0:
                        print('活动订单里活动时间检查通过')
                        sleep(2)
                    else:
...
#*******************************************************
    def test_wode_canceljoin_tc039(self):
        ...
        driver.find_element_by_id('cn.com.weilaihui3:id/my_palace_appointment_tv').click()
        sleep(3)
        ch=driver.find_elements_by_xpath('//*[contains(@text,"取消报名")]')
        if len(ch) != 0:
            print('取消报名按钮存在，检查通过')
            sleep(1)
            ...
            sleep(3)
            #checking
            ch1=driver.find_elements_by_xpath('//*[contains(@text,"取消成功")]')
            if len(ch1) != 0:
                print('取消报名成功')
                sleep(2)
                driver.find_element_by_xpath('//*[@text="完成"]').click()
                ...
                sleep(4)
                #暂无活动预约
                ch2=driver.find_elements_by_xpath('//*[@text="自动化测试活动1"]')
                if len(ch2) == 0:
...
#*******************************************************
    def test_faxian_expershare_tc040(self):
        ...
        sleep(2)
        #分享图标
        share=driver.find_elements_by_xpath('//android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.webkit.WebView[1]/android.webkit.WebView[1]/android.view.View[1]/android.view.View[2]')
        sleep(2)
        if len(share) != 0:
            print('分享按钮存在,检查通过')
            sleep(2)
...
#*******************************************************
    def test_jingxi_giftshare_tc041(self):
        ...
        for i in range(6):
            driver.swipe(50,1900,50,150,1000)
            sleep(2)
        #driver.swipe(50,1900,50,1600,1000)
        sleep(2)
        u1=driver.find_elements_by_xpath('//*[@text="Blue Sky 小咖杯"]')
        if len(u1) != 0:
            print('需要兑换的商品存在，检查通过')
            ...
            sleep(2)
            #分享图标
            share=driver.find_elements_by_xpath('//*[@resource-id="app"]/android.view.View[1]/android.view.View[3]')
            sleep(2)
            if len(share) != 0:
                print('分享按钮存在,检查通过')
                sleep(2)
                ...
                if len(wh) != 0:
                    ...
                    sleep(1)
                    now0=time.strftime('%Y-%m-%d %H_%M_%S')
                    word.send_keys('人生苦短商品微信好友:'+now0)
                    sleep(1)
                    #分享
                    driver.find_element_by_xpath('//android.widget.Button[@text="分享"]').click()
                    sleep(1)
                ...
                if len(pyq) != 0:
                    ...
                    sleep(1)
                    now2=time.strftime('%Y-%m-%d %H_%M_%S')
                    word2.send_keys('人生苦短商品朋友圈:'+now2)
                    sleep(1)
                    #发表
                    #driver.find_element_by_xpath('//android.widget.TextView[@text="发表"]').click()
                    driver.find_element_by_id('com.tencent.mm:id/j0').click()
                ...
                if len(mf) != 0:
                    ...
                    sleep(3)
                    #Sam8198
                    driver.find_elements_by_xpath('//*[contains(@text,"Sam8")]')[0].click()
                    sleep(1)
                    #检查toast
                    save4=driver.find_elements_by_xpath('//*[contains(@text,"分享成功")]')
                    if len(save4) != 0:
        ...
        if len(u1) != 0:
            ...
            if len(add2b) != 0:
                ...
                if '1' in ch1:
                    ...
                    driver.press_keycode('4')
                    sleep(2)
                    u2=driver.find_elements_by_xpath('//*[@text="Kaco百色双头水彩笔"]')
                    if len(u2) != 0:
...
#*******************************************************
    def test_wode_joinnio_tc048(self):
        ...
        sleep(2)
        #软件开发
        TouchAction(driver).tap(x=540,y=996).release().perform()
        sleep(2)
        #允许
        allow=driver.find_elements_by_xpath('//*[@text="允许"]')
        if len(allow) != 0:
...
#*******************************************************
    def test_aiche_cityplan_tc049(self):
        ...
        for i in range(2):
            driver.swipe(50,1700,50,200,1000)
            sleep(2)
        driver.swipe(50,1700,50,700,1000)
        sleep(2)
        ...
        if len(city) != 0:
            ...
            TouchAction(driver).tap(x=121,y=2050).release().perform()
            sleep(2)
            driver.find_element_by_xpath('//*[contains(@text,"哈尔滨市")]').click()
            sleep(4)
            #代客上牌
            ch1=driver.find_elements_by_xpath('//*[@text="NIO城市服务规划"]')
            ch2=driver.find_elements_by_xpath('//*[@text="哈尔滨市"]')
            ch3=driver.find_elements_by_xpath('//*[@text="代客上牌"]')
            if len(ch1) != 0 and len(ch2) != 0 and len(ch3) != 0:
                print('哈尔滨市城市服务规划显示正常')
                sleep(1)
            else:
                print('哈尔滨市城市服务规划显示不正常，请检查原因')
                sleep(1)
                now=time.strftime('%Y-%m-%d %H_%M_%S')
...
#*******************************************************
    def test_aiche_rechargemap_tc050(self):
        ...
        if len(cmap) != 0:
            ...
            #760，773
            TouchAction(driver).tap(x=782,y=783).release().perform()
            sleep(4)
            """
            now=time.strftime('%Y-%m-%d %H_%M_%S')
